...
class BoatClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat_class" do
    assert_difference('BoatClass.count') do
      post boat_classes_url, params: { boat_class: { external_id: @boat_class.external_id, external_system: @boat_class.external_system, handicap: @boat_class.handicap, name: @boat_class.name } }
    end
  ...
  test "should update boat_class" do
    patch boat_class_url(@boat_class), params: { boat_class: { external_id: @boat_class.external_id, external_system: @boat_class.external_system, handicap: @boat_class.handicap, name: @boat_class.name } }

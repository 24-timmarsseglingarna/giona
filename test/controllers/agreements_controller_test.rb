...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { description: @agreement.description, name: @agreement.name } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { description: @agreement.description, name: @agreement.name } }
